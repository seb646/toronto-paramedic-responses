...
simulated_emergent_care_data <-
  tibble(
    # Define the type of pre-hospital care: while the raw data has multiple values for this, we only use Emergency Requests for Service
    ...
    # Vary the data between 200,000 and 300,000
    "Actual" = sample(
      x = c(200000:350000),
      size = 8,
      replace = TRUE
...
simulated_incident_data <-
  tibble(
    # Vary the date between January 2, 2021 and December 31, 2021
    ...
    # Randomly pick an incident type1000 times
